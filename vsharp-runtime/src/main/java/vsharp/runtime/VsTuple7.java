...
/// Runtime carrier for a C# value tuple of arity 7 (`System.ValueTuple`).
///
...
public record VsTuple7<T1, T2, T3, T4, T5, T6, T7>(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7) {
