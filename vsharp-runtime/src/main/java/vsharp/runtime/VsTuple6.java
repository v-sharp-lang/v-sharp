...
/// Runtime carrier for a C# value tuple of arity 6 (`System.ValueTuple`).
///
...
public record VsTuple6<T1, T2, T3, T4, T5, T6>(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6) {
